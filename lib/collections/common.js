...
LatLongSchema = new SimpleSchema({
  lat: {
    type: Number,
    label: "Latitude",
    min: 1
...
// -- Daily scheduled Aggregation related collections declared with schemas
...
OaAvgWeightDaily = new Meteor.Collection('oaAvgWeightDaily');

OaAvgWeightDaily.attachSchema(new SimpleSchema({
  updatedAt: {
    type: Date,
    label: "Created On",
    autoValue: function() {
  ...
  avgWeight: {
    type: Number,
    label: "New Weight Value",
    decimal: true,
    min:0,
    optional: true
  }
}));
OaAvgActivityDaily = new Meteor.Collection('oaAvgActivityDaily');

OaAvgActivityDaily.attachSchema(new SimpleSchema({
  activityDate: {
    type: Date,
    label: "Activity Date",
    autoValue: function() {
